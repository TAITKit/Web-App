let apps = [
  {
    ...
    authors: ['Chuan-An Lin', 'Hen-Hsen Huang', 'Zi-Yuan Chen', 'Hsin-Hsi Chen'], // or key to user
    units: ['台灣大學資訊系'], // or key to user
    categories: ['NLP', 'Discourse', '遞迴類神經網路'],
    abstract: '中文語篇剖析有四項子任務，包含初級語篇單元分割、' +
  ...
  },
  {
    ...
    authors: ['Sun Junyi'], // or key to user
    units: [], // or key to user
    categories: ['NLP', 'segmentation', 'chinese', 'HMM'],
    abstract: 'Built to be the best Python Chinese word segmentation module',
    links: [
      { url: 'https://github.com/fxsjy/jieba', name: 'Github' },
    ...
    inputs: [
      ...
      },
      {
        name: 'suffix',
        type: 'text',
        description: '句子的後綴。不會斷詞，僅作 API 測試之用。'
      }
    ],
    configs: [
      {
